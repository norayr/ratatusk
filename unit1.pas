...
begin
  ...
  // Configure the IPMCast server for mDNS responses.
  // Use BoundPort to specify the port to bind.
  IdIPMCastServer1.BoundPort := 5353;            // mDNS standard port.
  IdIPMCastServer1.MulticastGroup := '224.0.0.251';// Join the mDNS multicast group.
  IdIPMCastServer1.Active := True;

  // Start our multicast receiver thread.
